def update_status
  ...
  epic_tragedy[:montague][:hero][:status] ? epic_tragedy[:montague][:hero][:status] = "dead" : "key not found"
  epic_tragedy[:capulet][:heroine][:status] ? epic_tragedy[:capulet][:heroine][:status] = "dead" : "key not found"
